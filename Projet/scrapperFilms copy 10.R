...
conn <- dbConnect(SQLite(), "films2010s copy 10.sqlite")
...
i <- 185769 #Clé primaire incrémentée à la main pour la stocker en variable et reprendre le script de n'importe où
while (i < 248961) {
    tryCatch({
