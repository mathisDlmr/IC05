...
driver <- rsDriver(browser = "firefox", port = 4424L, verbose = F, chromever = NULL)
remDr <- driver[["client"]]
...
i <- 182926 #Clé primaire incrémentée à la main pour la stocker en variable et reprendre le script de n'importe où
while (i < 248961) {
    tryCatch({
