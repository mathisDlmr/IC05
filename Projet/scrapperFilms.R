...
scrapperInfoBasiques <- function(page, id) {
    ...
    pays <- ifelse(length(xpathSApply(page, '//*[@id="tab-details"]/h3/span[text()="Country"]/following-sibling::p[1]/a[1]/text()', xmlValue)) == 0, "NA", xpathSApply(page, '//*[@id="tab-details"]/h3/span[text()="Country"]/following-sibling::p[1]/a[1]/text()', xmlValue))
...
i <- 39 #Clé primaire incrémentée à la main pour la stocker en variable et reprendre le script de n'importe où
while (i < 533918) {
